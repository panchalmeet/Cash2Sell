...
class AdminUserSeeder extends Seeder
{
    ...
    public $adminUserArr = [
        [
            'first_name' => 'Admin',
            'last_name' => 'Admin',
            'email' => 'admin@cash2sell.com',
            'mobile_number' => '9687113602',
            'role_id' => 1,
            'status' => 1
        ],
        [
            'first_name' => 'Pritesh',
            'last_name' => 'Bharmbhatt',
            'email' => 'pritesh@cash2sell.com',
            'mobile_number' => '9687113603',
            'role_id' => 2,
            'status' => 1
        ],
        [
            'first_name' => 'Meet',
            'last_name' => 'Panchal',
            'email' => 'meet@cash2sell.com',
            'mobile_number' => '9687113604',
            'role_id' => 2,
            'status' => 1
        ],
    ];
